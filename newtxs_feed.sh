...
wscat -c wss://${server}/ws ${authorization_header} --execute '{"method":"subscribe", "params": ["newTxs", {"include": ["all"], "filters": "({mentions} IN ['9xQeWvG816bUx9EPjHmaT23yvVM2ZWbrrpZb9PusVFin'])"}]}'
